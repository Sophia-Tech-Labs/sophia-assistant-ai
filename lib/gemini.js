  ...
  try {
    ...
    const chat = ai.chats.create({
      ...
      config: {
        ...
        tools:[{
        	functionDeclarations:[tools.changeToneFunction,tools.tagAllFunction,tools.unlockViewOnceFunction,tools.startWCGFunction,tools.endWCGFunction,tools.wcgStatusFunction]
        }]
      },
      history
    });
