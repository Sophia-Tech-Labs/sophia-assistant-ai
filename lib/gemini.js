  ...
  try {
    ...
    const chat = ai.chats.create({
      ...
      config: {
        ...
        tools:[{
        	functionDeclarations:[tools.changeToneFunction,tools.tagAllFunction,tools.unlockViewOnceFunction,tools.unlockViewOnceToDMFunction,tools.turnOnAntilinkFunction,tools.turnOffAntilinkFunction,tools.startWCGFunction,tools.endWCGFunction,tools.wcgStatusFunction]
        }]
      },
      history
    });
