...
const downloadTikTokVideoFunction = {
  name: "download-tiktok-video",
  description: `
Only call this function when the user explicitly asks you to download a TikTok video.
...
Do NOT call this if the user does not provide a valid TikTok video link.
The parameter "link" is the TikTok video URL that Sophia will download.
Example: "Sophia download TikTok https://www.tiktok.com/@username/video/1234567890"
  `.trim(),
  parameters: {
    type: Type.OBJECT,
    properties: {
...
const downloadInstagramVideoFunction = {
  name: "download-instagram-video",
  description: `
Only call this function when the user explicitly asks you to download an Instagram video or reel.
...
Do NOT call this if the user does not provide a valid Instagram video or reel link.
The parameter "link" is the Instagram video or reel URL that Sophia will download.
Example: "Sophia download Instagram https://www.instagram.com/reel/ABC123xyz/"
  `.trim(),
  parameters: {
    type: Type.OBJECT,
    properties: {
      link: {
        type: Type.STRING,
        description: "The URL of the Instagram video or reel to download."
      }
    },
    required: ["link"]
  }
